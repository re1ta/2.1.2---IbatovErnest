...
if not data: print("Нет данных")
    ...
    print(f"Динамика количества вакансий по годам для выбранной профессии: {result.get_vacancies_by_year_for_profession()}")
    ...
    Report(result.get_salary_by_year(),
           ...
           profession_name).generate_image()
